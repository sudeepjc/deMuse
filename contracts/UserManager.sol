...
/**
    ...
    @notice : One admin gets created on deployment and later only he can add new admins/ users
*/
contract UserManager{
    ...
    // modifier onlyAdmin() {
    //     require(msg.sender == admin,"Only Admins allowed to perform operation");
    //     _;
    // }
